package com.kumar.producer.producer;
...
public class LibraryEventProducer {
    ...
    public CompletableFuture<SendResult<Integer, String>> sendLibraryEventWithHeaderRecord(LibraryEvent libraryEvent) throws JsonProcessingException {
        var key = libraryEvent.getLibraryEventId();
        var value = objectMapper.writeValueAsString(libraryEvent);

        ProducerRecord<Integer, String> producerRecord = buildProducerRecord(key,value); //With Header Record
        // 1. blocking call - get metadata about the kafka cluster
        //2.Send message happens - Returns a CompletableFuture
